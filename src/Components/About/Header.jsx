...
export default function Header() {
  ...
  return (
    <div className='bg-[#255852]  text-white flex w-[100%] xl:mb-[140px] max-xl:mb-[5rem] max-md:mb-[2rem]'>
       ...
       <span className='xl:text-3xl max-xl:text-2xl   font-bold uppercase'>
        ...
        <div className='flex gap-10 items-center max-md:hidden' >
            ...
            <li className='px-[2rem] py-[2.5rem] border-t-[0.8rem] border-transparent hover:border-[#113f23]'><a href='/'>Home</a> </li>
              <li className='px-[1.5rem] py-[2.5rem] border-t-[0.8rem]  tracking-wider transition-all border-[#113f23]'><a href="/about"> About</a></li>
  ...
  <div className="overlay-content ml-[1rem]">
    ...
    <a href="/about"  className='border-l-[7px] border-[#204916]  mb-[20px] w-[15rem] pl-[1rem]' style={{paddingLeft: "2rem"}}>About</a>
