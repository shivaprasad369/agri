...
export default function Header() {
  ...
  return (
    <div className='bg-[#255852] text-white flex w-[100%] max-md:mb-[50px] md:mb-[140px]'>
      <div className='flex justify-between max-md:py-[1rem] items-center px-[5%] w-[100%]'>
       <span className='xl:text-3xl max-xl:text-2xl   font-bold uppercase'>
        ...
        <div className='flex max-md:hidden gap-10 items-center' >
            <ul className='text-[18px] flex leading-[1.7em]'>
            <li className='px-[2rem] py-[2.5rem] border-t-[0.8rem] border-transparent hover:border-[#113f23]'><a href='/'>Home</a> </li>
              ...
              <li className='px-[1.5rem] py-[2.5rem] border-t-[0.8rem]  tracking-wider transition-all border-[#113f23]'><a href="/service"> Services</a></li>
  ...
  <div className="overlay-content ml-[1rem]">
    <a href="/" className='border-l-[7px] border-transparent hover:border-[#204916]   mb-[20px] w-[15rem] pl-[1rem]' style={{paddingLeft: "2rem"}}>Home</a>
    ...
    <a href="/service"  className='border-l-[7px] border-[#204916]  mb-[20px] w-[15rem] pl-[1rem]' style={{paddingLeft: "2rem"}}>Services</a>
