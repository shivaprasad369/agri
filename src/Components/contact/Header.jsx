...
export default function Header() {
       ...
       <span className='xl:text-3xl max-xl:text-2xl   font-bold uppercase'>
        ...
        <div className='md:hidden'>
            ...
            <ul className='text-[18px] flex leading-[1.7em] '>
              ...
              <li className='px-[1.5rem] py-[2.5rem] border-t-[0.8rem]  tracking-wider transition-all border-[#113f23]'><a href="contact">Contact</a></li>
            </ul>
  ...
  <div className="overlay-content ml-[1rem]">
    ...
    <a href="/contact" className='border-l-[7px] border-[#204916]   mb-[20px] w-[15rem] pl-[1rem]' style={{paddingLeft: "2rem"}}>Contact</a>
  </div>
</div>
    </div>
  )
